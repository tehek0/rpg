...
QString item::html_weight() {
    ...
    QString html_weight = QString("<p><img src=\":/ui_weight_icon.png\" width=\"15\" height=\"15\" style=\"vertical-align: middle;\"><font size=\"2\"> Вес: %1%2</font><\p>").arg(_base_weight).arg((total_weight == _base_weight ? QString("") : QString(" (%1)").arg(total_weight)));
    return html_weight;
}

QString item::html_cost() {
    unsigned int total_cost = _stack * _base_cost;
    QString html_cost = QString("<p><img src=\":/ui_base_cost_icon.png\" width=\"15\" height=\"15\" style=\"vertical-align: middle;\"><font size=\"2\"> Стоимость: %1%2</font></p>").arg(_base_cost).arg((total_cost == _base_cost ? QString("") : QString(" (%1)").arg(total_cost)));
    return html_cost;
}
...
QString has_base_dmg::html_base_dmg() {
    ...
    QString html_base_dmg = QString("<p><img src=\":/ui_damage_icon.png\" width=\"15\" height=\"15\" style=\"vertical-align: middle;\"><font size=\"2\"> %1</font></p>").arg(str_insert);
...
QString has_ammo_type::html_ammo_type() {
    ...
    QString html_ammo_type = QString("<p><img src=\":/ui_ammo_icon.png\" width=\"15\" height=\"15\" style=\"vertical-align: middle;\"><font size=\"2\"> Тип боезапаса: %1</font></p>").arg(ammo_type_to_str(_ammo_type));
    return html_ammo_type;
}

QString has_energy_cost::html_energy_cost() {
    QString html_energy_cost = QString("<p><img src=\":/ui_energy_cost_icon.png\" width=\"15\" height=\"15\" style=\"vertical-align: middle;\"><font size=\"2\"> Стоимость хода: %1</font></p>").arg(_energy_cost);
...
QString armor::html_armor_points() {
    ...
    QString html_armor_points = QString("<p><img src=\":/ui_armor_icon.png\" width=\"15\" height=\"15\" style=\"vertical-align: middle;\"><font size=\"2\"> %1</font></p>").arg(str_insert);
...
QString armor::html_armor_bonus() {
    ...
    QString html_armor_bonus = QString("<p><img src=\":/ui_armor_bonus_icon.png\" width=\"15\" height=\"15\" style=\"vertical-align: middle;\"><font size=\"2\"> %1</font></p>").arg(str_insert);
...
QString consumable::html_on_use() {
    ...
    QString html_on_use = QString("<p><img src=\":/ui_use_effect_icon.png\" width=\"15\" height=\"15\" style=\"vertical-align: middle;\"><font size=\"2\"> %1</font></p>").arg(str_insert);
    return html_on_use;
}
