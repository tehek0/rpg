...
int main(int argc, char** argv)
{
    ...
    global::w.menu_scene = throw_menu_scene();
    ...
    // ef->play();
    displayable* disppp = new displayable("icon_inv_collect_shrimp", QPoint(1880, 1010), QSize(100, 100), false);
    // disppp->_disp->setParent(global::w.menu_screen);
    // global::w.menu_screen->scene()->addWidget(disppp->_disp);
    // disppp->_disp->show();
    global::w.menu_scene->add(disppp->_disp);
